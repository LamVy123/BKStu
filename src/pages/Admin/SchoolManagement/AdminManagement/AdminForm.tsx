...
interface AdminFormProps {
    setOpenAdminForm: React.Dispatch<React.SetStateAction<boolean>>
}

const AdminForm: React.FC<AdminFormProps> = ({ setOpenAdminForm }: AdminFormProps) => {
    ...
    const generateID = (): string => {
        ...
        const countStr = (adminCount + 1).toString().padStart(6, '0');
        return `AD${year}${countStr}`;
    }
