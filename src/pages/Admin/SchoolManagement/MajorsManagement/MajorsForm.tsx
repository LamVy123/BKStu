    ...
    const Header: React.FC = () => {
        return (
            <div className="w-full h-20 flex flex-row justify-start items-center p-4 bg-primary rounded-t-2xl">
                <h1 className="text-4xl max-md:text-2xl font-bold">Thêm Ngành mới</h1>
                ...
                <div className="w-full h-fit flex flex-col gap-8">
                    ...
                    <div className="w-12/12 max-md:w-full h-fit flex flex-col gap-8">
                        ...
                        <div className="w-full h-fit grid grid-cols-7 max-md:grid-cols-5 gap-2">
                            ...
                            <Select id="faculty" name="faculty" height={10} option={facultyOptionList} className="w-full col-span-5" />
                        </div>
                    ...
                    <div className="w-full h-fit flex flex-col items-start justify-center">
                        <label htmlFor="description" className="py-2 font-bold flex flex-row gap-2 col-span-2 max-md:col-span-full">Mô tả Ngành<h1 className="text-red-500">*</h1></label>
