...
import { RefreashIcon, LoadingIcon, ArrowLeftIcon, TrashIcon } from "../../assets/Icon";
import { Semester } from "../../class&interface/Semester";
import React from "react";
import { semesterColRef, courseColRef, courseDetailColRef, userDetaiColRef } from "../../config/firebase";
import { collection, deleteDoc, doc, getDoc, getDocs, or, query, setDoc, where } from "firebase/firestore";
import { SemesterFactory } from "../../class&interface/Semester";
import { SearchIcon } from "../../assets/Icon";
import { FormEvent } from "react";
import { CourseFactory, Course } from "../../class&interface/Course";
...
const StudentCourseRegistration: React.FC = () => {
    ...
    const SemesterSelect: React.FC = () => {
        ...
        return (
            <div className="w-full h-full flex flex-col justify-center items-center">
                <Header />
                <div className="w-8/12 max-md:w-full h-full flex flex-col bg-white border border-black border-solid rounded-md">
                    ...
                    <div className="w-full h-full flex flex-col p-4 gap-0 overflow-hidden">
                        <div className="w-full h-16 grid grid-cols-12 p-4">
                            ...
                            <div className="w-full h-full flex justify-center items-center">
                                <motion.button whileTap={{ scale: .9 }} onClick={() => { setSemesterList([]); setReset(reset => !reset) }} className="hover:bg-gray-300 p-2 rounded-md">
    ...
    const CourseSelect: React.FC = () => {
        ...
        const Header: React.FC = () => {
            ...
            return (
                <div className="w-full h-20 flex flex-row max-md:flex-col p-2 gap-4 items-center max-md:items-end ml-auto">
                    <motion.button whileTap={{ scale: 0.9 }} type="button" onClick={() => setCurrentPage(0)}>
        ...
        return (
            <>
                <div className="w-full h-full border-solid border p-4 border-black rounded-md shadow-sm bg-white shadow-gray-700 flex items-center justify-center">
                                                                        ...
                                                                        <div className="w-full h-full flex justify-center items-center">
                                                                            <div className="w-fit h-fit p-8 gap-8 rounded-2xl bg-white border border-black border-solid flex flex-col justify-end items-end">
                                                                                ...
                                                                                <div className="w-fit h-fit flex flex-row gap-8">
                                                                                    <button type="button" onClick={() => setOpen1(false)} className="w-28 h-12 bg-red-500 flex justify-center items-center font-bold rounded-md hover:bg-red-700 text-white p-4">Cancel</button>
                                                                                    <button type="button" onClick={() => { register_course(); setOpen1(false) }} className="w-28 h-12 bg-green-400 flex justify-center items-center font-bold rounded-md hover:bg-green-600 text-white p-4">Confirm</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </Model>}
                                                                    ...
                                                                    {open2 && <Model>
                                                                        <div className="w-full h-full flex justify-center items-center">
                                                                            <div className="w-fit h-fit p-8 gap-8 rounded-2xl bg-white border border-black border-solid flex flex-col justify-end items-end">
                                                                                ...
                                                                                <div className="w-fit h-fit flex flex-row gap-8">
                                                                                    <button type="button" onClick={() => setOpen2(false)} className="w-28 h-12 bg-red-500 flex justify-center items-center font-bold rounded-md hover:bg-red-700 text-white p-4">Cancel</button>
                                                                                    <button type="button" onClick={() => { delete_course(); setOpen2(false) }} className="w-28 h-12 bg-green-400 flex justify-center items-center font-bold rounded-md hover:bg-green-600 text-white p-4">Confirm</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </Model>}
