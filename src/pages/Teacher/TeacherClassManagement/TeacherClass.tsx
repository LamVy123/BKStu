...
const ClassInfor: React.FC<ClassProp> = ({ currentClassID }) => {
    ...
    const Header: React.FC = () => {
        return (
            <div className="w-full min-h-fit flex flex-col justify-center items-center gap-4">
                <div className="w-full min-h-10 h-fit flex justify-between items-start text-3xl font-bold">

                    <button className="" onClick={() => { navigate('/class_management') }}>
    ...
    const Body: React.FC = () => {
        switch (currentPage) {
            case 0:
                return <ClassSection currentClassID={currentClassID} />
            case 1:
                return <ClassStudentList currentClassID={currentClassID} />
            default:
                return null
        }
    }
...
const ClassSection: React.FC<ClassSectionProps> = ({ currentClassID }) => {
...
const ClassStudentList: React.FC<ClassStudentListProps> = ({ currentClassID }) => {
    ...
    return (
        <>
            ...
            <div className="w-10/12 h-full flex flex-col items-center justify-start p-4">
                <div className="w-10/12 h-fit flex flex-row justify-between items-center gap-20 max-md:gap-8">
